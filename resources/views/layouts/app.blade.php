<x-layouts.base>
    ...
    @if(in_array(request()->route()->getName(), ['dashboard', 'profile', 'drivers', 'drivercreate', 'driverdetails', 'driveredit', 'earning', 'riders', 'rideredit', 'ridercreate', 'riderequest', 'riderequestdetails', 'driverratings', 'driverratingdetails', 'riderratings', 'riderratingdetails', 'feedback', 'feedbackdetails', 'profile-example', 'users', 'bootstrap-tables', 'transactions',
