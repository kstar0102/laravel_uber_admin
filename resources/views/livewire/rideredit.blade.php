                        ...
                        <div class="d-flex align-items-center">
                            <div class="me-3">
                                ...
                                @elseif(gettype($photo) != 'string')
                                    <img src="{{ $photo->temporaryUrl() }}" class="rounded avatar-xl" alt="Driver Photo">
                                @else
                ...
                <div class="card card-body border-0 shadow mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input wire:model.lazy="name" class="form-control" id="name" type="text" placeholder="Enter your name" value="{{ $name }}">
