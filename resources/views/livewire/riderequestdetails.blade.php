    ...
    <div class="d-block mb-4 mb-md-0">
        <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item"><a href="/riderequest">Ride Request List</a></li>
                <li class="breadcrumb-item active" aria-current="page">Ride Request Details</li>
            </ol>
        </nav>
        <h2 class="h4">Ride Request Details</h2>
    </div>
    ...
    <div class="row">
        <div class="col-12 col-xl-8">
            <div class="card card-body border-0 shadow mb-4">
                <h2 class="h5 mb-4">Ride Request</h2>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div>
                            <label for="first_name">Pickup Address</label>
                            <p>37:46, Torices, Cartagena de Indias, Bolívar 130002, Colombia</p>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div>
                            <label for="last_name">Drop Address</label>
                            <p>Cra. 18 #11 26, Pie Del Cerro, Cartagena de Indias, Provincia de Cartagena, Bolívar, Colombia</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="row mb-2">
                            ...
                            <div class="col-3">
                                <small>2024-05-31 00:59:09</small>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-1">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-3">
                                <small>2024-05-31 01:43:11</small>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-1">
        ...
        <div class="col-12 col-xl-4">
            <div class="card card-body border-0 shadow mb-4">
                ...
                <div class="row">
                    <div class="col-3">
                        <img src="../../assets/img/team/profile-picture-5.jpg" class="rounded-1" />
                    </div>
                    <div class="col-9">
                        <p class="mb-0">Henrry Paternina</p>
                        <p class="mb-0">+1 2089110928</p>
                        <p class="mb-0">henrrypaternina@gmail.com</p>
                    </div>
                </div>
            </div>
            <div class="card card-body border-0 shadow mb-4">
                ...
                <div class="row">
                    <div class="col-3">
                        <img src="../../assets/img/team/profile-picture-1.jpg" class="rounded-1" />
                    </div>
                    <div class="col-9">
                        <p class="mb-0">Alex Miller</p>
                        <p class="mb-0">+1 9838292838</p>
                        <p class="mb-0">alexmiller@gmail.com</p>
                    </div>
                </div>
            </div>
        </div>
