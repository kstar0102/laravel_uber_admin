            ...
            @foreach($drivers as $driver)
                <tr>
                    <td>
                        ...
                        <img src="{{ asset('storage/' . $driver->driver_photo) }}" alt="Driver Photo" class="img-fluid rounded-circle" width="50">
                        @else
                        N/A
                        @endif
                    </td>
                    ...
                    <td>
                        @if($driver->license_verification)
                    ...
                    <td>
                        <div class="d-flex aligh-items-center">
                            ...
                            <a href="/driver/details/1" class="me-md-1">
                                <i class="fas fa-eye text-primary"></i>
                            </a>
                            <span class="me-md-1 driver-del-btn" data-id="1">
